...
pynvml is strongly preferred on Linux — nvidia-smi fork() overhead at 50ms
...
Compatibility:
    - sm_75+ (Turing, RTX 20xx / GTX 16xx): SA2, SDPA
...
if sys.platform == "win32":
    ...
    print("          Use bench_windows.py on Windows instead.")
...
# On Linux, spawning a subprocess every 50ms has measurable fork() overhead;
